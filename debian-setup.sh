...
case "$arch" in
  x86_64|amd64)
    ...
    golang sublist3r tcpspy mono-complete zsh qemu-system-x86 libvirt-daemon-system virtinst \
    virt-manager virt-viewer ovmf swtpm qemu-utils guestfs-tools libosinfo-bin tuned fonts-powerline autojump
    ;;
  i?86)
